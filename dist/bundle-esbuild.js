(() => {
  // EldenRingAPIClient.js
  var EldenRingAPIClient = class {
    /**
     * @private
     */
    ...
    mapDataToCards() {
      ...
      for (const item of data) {
        ...
        let html = `
                  ...
                  <button><a href="https://eldenring.fanapis.com/api/${this.#path}/${item.id}" target="_blank">Read More</a></button>
                  `;
        card.innerHTML = html;
        markup.push(card);
  ...
  // Bosses.js
  var Bosses = class extends EldenRingAPIClient {
    constructor() {
      super("bosses");
    }
  };
